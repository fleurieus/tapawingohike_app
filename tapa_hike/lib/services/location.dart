...
Map locationConfirmdData(id) => {
      "endpoint": "destinationConfirmed",
      "data": {"id": id}
    };
...
class Destination {
  ...
  Widget get marker => LocationMarkerLayer(
      ...
      style: LocationMarkerStyle(marker: DefaultLocationMarker(color: colorMapping[type]), markerSize: Size.square(size)));
